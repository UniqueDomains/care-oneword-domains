...
**Public extract:** 8,009 rows · **Live catalog:** 8,008 domains
...
- `care.csv` — public CSV extract (8,009 rows)
- `care.json` — public JSON extract (8,009 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,009-row public sample | 8,008 live domains                               |
