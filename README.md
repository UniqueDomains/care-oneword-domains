...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C012%20rows-8250df">
...
**Public extract:** 8,012 rows · **Live catalog:** 8,008 domains
...
- `care.csv` — public CSV extract (8,012 rows)
- `care.json` — public JSON extract (8,012 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,012-row public sample | 8,008 live domains                               |
...
> Unique Domains. *Available .CARE One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
