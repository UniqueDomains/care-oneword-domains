# Available .CARE One-Word Domains (8,002)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C006%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C002%20domains-6f42c1">
  <img alt="formats" src="https://img.shields.io/badge/formats-CSV%20%7C%20JSON-f59e0b">
  <img alt="license" src="https://img.shields.io/badge/license-see%20LICENSE-6b7280">
</p>

Daily-updated dataset of available and resale .care one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 8,006 rows · **Live catalog:** 8,002 domains
...
- `care.csv` — public CSV extract (8,006 rows)
- `care.json` — public JSON extract (8,006 rows)
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ---------------- |
| stock.care      | available | $59.98    | —             | 68             | 40     | 5      | namecheap        |
| flow.care       | resell    | —         | —             | 96             | 67     | 4      | Sav.com, LLC     |
...
| wizard.care     | premium   | $123.75   | $123.75       | 118            | 46     | 6      | name.com         |
...
| goon.care       | available | $29.99    | $56.99        | 80             | 36     | 5      | name.com         |
...
| blue.care       | resell    | —         | —             | 92             | 59     | 4      | Dynadot Inc      |
...
| ----------------------- | ------------------------------------------------ |
| 8,006-row public sample | 8,002 live domains                               |
...
> Unique Domains. *Available .CARE One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
